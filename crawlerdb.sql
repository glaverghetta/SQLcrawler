...
CREATE TABLE IF NOT EXISTS `crawler`.`analyses` (
  ...
  `sql_usage` ENUM("NONE", "HARDCODED", "STRING_CONCAT", "PARAMATIZED_QUERY_AND_CONCAT", "PARAMATIZED_QUERY") NULL,
  ...
  `order_group_usage` ENUM("NONE", "HARDCODED", "STRING_CONCAT", "PARAMATIZED_QUERY_AND_CONCAT", "PARAMATIZED_QUERY") NULL,
  `like_usage` ENUM("NONE", "HARDCODED", "STRING_CONCAT", "PARAMATIZED_QUERY_AND_CONCAT", "PARAMATIZED_QUERY") NULL,
  `column_usage` ENUM("NONE", "HARDCODED", "STRING_CONCAT", "PARAMATIZED_QUERY_AND_CONCAT", "PARAMATIZED_QUERY") NULL,
  `table_usage` ENUM("NONE", "HARDCODED", "STRING_CONCAT", "PARAMATIZED_QUERY_AND_CONCAT", "PARAMATIZED_QUERY") NULL,
