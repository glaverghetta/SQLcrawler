...
CREATE TABLE IF NOT EXISTS `crawler`.`projects` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `gh_id_UNIQUE` (`gh_id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `crawler`.`repo_info` (
  `project` INT NOT NULL,
  `gh_id` VARCHAR(100) NULL,
  `description` TEXT CHARACTER SET 'utf8mb4' NULL,
  `releasesCount` INT NULL,
  `LRName` VARCHAR(100) NULL,
  `LRCreated` DATETIME NULL,
  `LRUpdated` DATETIME NULL,
  `stargazerCount` INT NULL,
  `forkCount` INT NULL,
