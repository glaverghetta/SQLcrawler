...
public class DBNameCodeAnalyzer implements CodeAnalyzer {
    ...
    private String mStringLitPattern = RegexConstants.STRING_LITERAL_CONCAT_WITH_DB + RegexConstants.CONCAT_VAR;
    private String mStringLitPatternInterpolation = RegexConstants.STRING_LITERAL_CONCAT_WITH_DB + RegexConstants.INTERPOLATION_VAR;
