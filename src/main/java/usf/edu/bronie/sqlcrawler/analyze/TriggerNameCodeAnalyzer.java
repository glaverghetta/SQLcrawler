...
public class TriggerNameCodeAnalyzer implements CodeAnalyzer {
    ...
    private String mStringLitPattern = RegexConstants.STRING_LITERAL_CONCAT_WITH_TRIGGER + RegexConstants.CONCAT_VAR;
    private String mStringLitPatternInterpolation = RegexConstants.STRING_LITERAL_CONCAT_WITH_TRIGGER + RegexConstants.INTERPOLATION_VAR;
    ...
    private static final String DBFIELD = "trig_usage";
