...
public class FunNameCodeAnalyzer implements CodeAnalyzer {
    ...
    private String mStringLitPattern = RegexConstants.STRING_LITERAL_CONCAT_WITH_FUN + RegexConstants.CONCAT_VAR;
    private String mStringLitPatternInterpolation = RegexConstants.STRING_LITERAL_CONCAT_WITH_FUN + RegexConstants.INTERPOLATION_VAR;
